...
class KeywordsMainForm:
    ...
    def _create_widgets(self):
        ...
        self.txt_result['yscrollcommand'] = self.scroll_result.set
        ...
        self.txt_error['yscrollcommand'] = self.scroll_error.set
    ...
    def _set_grid_positions(self):
        """Set widgets on grid"""
        self.content.grid(column=0, row=0, sticky=(tk.N, tk.S, tk.E, tk.W), pady=5, padx=5)

        self.lbl_url.grid(column=0, row=0, sticky=tk.W)
        self.entry_url.grid(column=1, row=0, columnspan=3, sticky=(tk.N, tk.E, tk.W), pady=5)
